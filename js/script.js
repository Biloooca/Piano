...
const keysView = document.querySelector('.piano__keys');
...
checkbox.addEventListener('change', ({ target }) => {
    if (target.checked) {
        ...
        keysView.classList.remove('disabled-keys');
        return
    }

    switcher.classList.remove('switcher--active');
    keysView.classList.add('disabled-keys');
})
